...
<html lang="en">
    <head>
        ...
        <title>Afro IT Solutions (AIT) E-Commerce</title>
        ...
        <section class="best_business_area row">
            ...
            <div class="row it_works">
              <?php
                        ...
                        $link = mysqli_connect('database', 'ekangakiuser', 'ekangakipassword', 'ekangakidb');
        ...
        <footer class="footer_area row">
            <div class="container custom-container">
                ...
                <div class="copy_right_area">
                    <h4 class="copy_right">© Copyright 2024 Aro IT Solutions Ecommerce | All Rights Reserved</h4>
                </div>
            </div>
        </footer>
